...
class PipelineContainerIntegrationTest {
 ...
 static void seedMetadata(){for(String sql:List.of("create table company(id uuid primary key,name text)","create table project(id uuid primary key,company_id uuid,name text,classification text)","create table environment(id uuid primary key,project_id uuid,code text)","create table server_node(id uuid primary key,environment_id uuid,host_id text,hostname text,ip_address text)","create table service_definition(id uuid primary key,project_id uuid,service_key text)","create table service_instance(id uuid primary key,service_id uuid,server_id uuid,instance_key text)","create table log_source(id uuid primary key,service_instance_id uuid,path_pattern text,log_type text,parser_profile text,timestamp_timezone text not null default 'UTC',enabled boolean)"))jdbc.execute(sql);jdbc.update("insert into company values(?::uuid,?)","00000000-0000-0000-0000-000000000001","Example");jdbc.update("insert into project values(?::uuid,?::uuid,?,?)","10000000-0000-0000-0000-000000000001","00000000-0000-0000-0000-000000000001","Demo Marketplace","CONFIDENTIAL");jdbc.update("insert into environment values(?::uuid,?::uuid,?)","20000000-0000-0000-0000-000000000003","10000000-0000-0000-0000-000000000001","PROD");jdbc.update("insert into server_node values(?::uuid,?::uuid,?,?,?)","30000000-0000-0000-0000-000000000001","20000000-0000-0000-0000-000000000003","prod-1","prod-1.local.test","192.0.2.1");jdbc.update("insert into service_definition values(?::uuid,?::uuid,?)","40000000-0000-0000-0000-000000000001","10000000-0000-0000-0000-000000000001","order");jdbc.update("insert into service_instance values(?::uuid,?::uuid,?::uuid,?)","50000000-0000-0000-0000-000000000001","40000000-0000-0000-0000-000000000001","30000000-0000-0000-0000-000000000001","order-1");jdbc.update("insert into log_source values(?::uuid,?::uuid,?,?,?,'UTC',true)","60000000-0000-0000-0000-000000000001","50000000-0000-0000-0000-000000000001","/logs/order/*.log","application","logback-json");}
}