...
public record LogSearchCriteria(UUID projectId,UUID environmentId,UUID serverId,UUID serviceId,UUID serviceInstanceId,UUID logSourceId,String level,Instant from,Instant to,
 ...
 public Normalized normalize(Clock clock){
  ...
  return new Normalized(projectId,environmentId,serverId,serviceId,serviceInstanceId,logSourceId,normalizedLevel,start,end,lower(normalizedTrace),lower(normalizedSpan),bounded(requestId,"requestId",200),bounded(correlationId,"correlationId",200),bounded(transactionId,"transactionId",200),bounded(orderToken,"orderToken",200),bounded(auctionId,"auctionId",200),bounded(exceptionType,"exceptionType",300),term,size,cursor);
 }
 ...
 public LogSearchCriteria(UUID projectId,UUID environmentId,UUID serverId,UUID serviceId,String level,Instant from,Instant to,String traceId,String spanId,String requestId,String correlationId,String transactionId,String orderToken,String auctionId,String exceptionType,String text,Integer pageSize,Cursor cursor){this(projectId,environmentId,serverId,serviceId,null,null,level,from,to,traceId,spanId,requestId,correlationId,transactionId,orderToken,auctionId,exceptionType,text,pageSize,cursor);}
 public record Normalized(UUID projectId,UUID environmentId,UUID serverId,UUID serviceId,UUID serviceInstanceId,UUID logSourceId,String level,Instant from,Instant to,String traceId,String spanId,String requestId,String correlationId,String transactionId,String orderToken,String auctionId,String exceptionType,String text,int pageSize,Cursor cursor){}
}
