...
import com.logatron.catalog.domain.CatalogEnums.*;import jakarta.validation.constraints.*;import java.time.Instant;import java.util.*;
public final class CatalogDtos{
 ...
 public record LogSourceView(UUID id,UUID serviceInstanceId,String pathPattern,String logType,String parserProfile,String multilineRule,boolean enabled,long configVersion){}
 ...
 public record CreateLogSourceRequest(@NotNull UUID serviceInstanceId,@NotBlank @Size(max=1000) String pathPattern,@NotBlank @Size(max=60) String logType,@NotBlank @Size(max=100) String parserProfile,@Size(max=4000) String multilineRule,boolean enabled){}
 public record UpdateLogSourceRequest(@NotBlank @Size(max=60) String logType,@NotBlank @Size(max=100) String parserProfile,@Size(max=4000) String multilineRule,boolean enabled){}
}
